    ...
    <section aria-labelledby="what-we-do" className="border-y border-neutral-200 bg-neutral-50">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <Reveal>
          ...
          <h2
            id="what-we-do"
            className={cn(displayFont, "mt-3 text-3xl tracking-tight text-neutral-900 sm:text-4xl")}
          >
            {t("services.headingPlain")}{" "}
            <span className="italic text-neutral-500">{t("services.headingItalic")}</span>
          </h2>
          <p className="mt-3 max-w-2xl text-neutral-600">{t("services.subtitle")}</p>
        </Reveal>
